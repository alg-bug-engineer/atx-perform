 ...
 * @param {{ audioUrl?: string, durationSec?: number }} [opts] - 预合成音频（幕 3/3b/4/5）
 */
export function triggerBroadcast(key, customText, opts = {}) {
...
/** 清空队列（切幕时由 sceneNarration 调用，配合 DigitalAvatar 打断当前条目） */
