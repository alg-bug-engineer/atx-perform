 ...
 * 渠化渐变段距经十路口约 90m（路段约 1/3 处）；进口 5 车道为
...
<template>
  ...
  <svg
    ...
    role="img"
    aria-label="奥体西路北向南渠化拓宽示意图：距经十路口90米处由3车道拓宽为5车道，两路口周期200秒与220秒不协调"
  >
    ...
    <!-- ── 渠化后终态（开场直接显示，无拓宽动画）：渐变段 x735→885，距经十路口约90m/路段1/3处 ── -->
    ...
    <!-- 90m 距离标注（渠化渐变起点 → 经十路口；线与双向箭头随图旋转成纵向） -->
